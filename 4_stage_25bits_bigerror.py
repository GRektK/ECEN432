...
for _ in range(4):
    ...
    RA_errors_fixed.append(np.random.normal(0, 120e-3))
...
RA_knobs = [0, 0, 0, 0]
for _ in range(4):
  comparator_offsets.append(np.random.normal(0,120e-3,6))
  RA_errors.append(np.random.normal(0,120e-3))
...
ax.set_title('Calibration Algorithm Comparison\n'
             '4-Stage Pipeline ADC (2.5 bits/stage, σ=120mV offsets, σ=120mV/V gain)',
             fontsize=14)
